...
int E_left =3; //The enabling of L298PDC motor driver board connection to the digital interface port 5
int M_left =6; //The enabling of L298PDC motor driver board connection to the digital interface port 4
